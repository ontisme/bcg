import{a as p,c as e,aA as F,b as C,d as B,aW as G,aX as H,e as E,u as W,f as L,h as M,a4 as j,i as K,bl as N,j as n,aU as U,ci as X}from"./index-DelEC5j5.js";import{u as q}from"./use-compitable-BZ-6egnN.js";import{g as J}from"./Space-Bc0YjomY.js";function D(t,b="default",a=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function Q(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[V]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
